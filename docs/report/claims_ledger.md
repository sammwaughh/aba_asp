...
| M11-C-004 | Greedy folding may reduce cat3 representation-order sensitivity on the m1.1 grid. | tentative → **weakened** | QI-002 greedy precedent; m1.1 cat3 σ failure; ABL-105 | **Not established.** Greedy smoke test ≠ nd cat3 A or B. ND vs greedy not sufficient to explain σ failure. m1.1 **analysed**; M1.2 grid is next test. | Project Plan / M1.2 | pending |
