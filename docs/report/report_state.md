...
9. **31 July Bucket 3 direction (approved method, not results)**
   ...
   - proceed one fixture at a time; H0–H6 are now complete / analysed (including
     H4b); H5 uses experimental `greedy_cautious` and is not an AAMAS-paper
     method; H6 is a procedural search-cost probe; H7 is signposted only;
...
1. **Milestone 1** — report-ready account of unguided ABA Learning's capabilities and
   ...
   Bucket 3 H0–H6 complete / analysed under Fabrizio's 31 July direction
   (incl. H4b, H5, H6 search-cost); H7 signposted; no Bucket 3 claim.
...
- defer Bucket 3 report claims until a separate evidence review and Samuel's decision;
  keep project-plan status aligned with completed H0–H6 (including H4b), with
  H7 signposted only;
