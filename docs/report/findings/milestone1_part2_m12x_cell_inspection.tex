...
\textbf{Status:} Stage-3 qualitative inspection \textbf{closed / analysed} (18/18 written); M12x evidence package locked for M1.3\\
...
\subsubsection{ECAI folding control flow}
...
\subsection{7. ECAI \(\times\) \texttt{m12\_u6\_g1\_min\_diff} \(\times\) \(t=x_2\)}
...
\subsection{8. ECAI \(\times\) \texttt{m12\_u6\_g1\_min\_diff} \(\times\) \(t=x_3\)}
...
\subsubsection{Intended hypothesis \(\mathcal{H}_{x_3}^\star\)}
...
\subsection{9. ECAI \(\times\) \texttt{m12\_u7\_diamond\_noisy} \(\times\) \(t=x_3\)}
...
\subsubsection{AAMAS folding control flow}
...
\subsection{16. AAMAS \(\times\) \texttt{m12\_u6\_g1\_min\_diff} \(\times\) \(t=x_2\)}
...
\subsection{17. AAMAS \(\times\) \texttt{m12\_u6\_g1\_min\_diff} \(\times\) \(t=x_3\)}
...
\subsection{18. AAMAS \(\times\) \texttt{m12\_u7\_diamond\_noisy} \(\times\) \(t=x_3\)}
