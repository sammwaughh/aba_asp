...
| M13 | — | m1.3 causal-recovery capabilities and limits of unguided ABA Learning | in progress | `M1.3-bucket1-claims.md` (locked); `M1.3-bucket2-claims.md` (locked); `M1.3-bucket3-claims.md` (M13-C3 H0 closed; H1–H7a analysed; no claim) | — | M13-C3 **H0 closed**; **H1–H7a run/analysed**; H7b not started. | Interim Experimentation / Progress (Milestone 1) | Bucket 3: H0–H7a analysed; next = H7b; no claim yet. |
...
| M13-C3 | M13 | Bucket 3 binary deterministic AND collider | **H0 closed**; **H1–H7a analysed** (no claim) | `experiment.md`; `learning_analysis.*`; `h1`–`h7a` records; `future_probes.*` | H0–H6 retained; H7a `nd_brave_sechk` on H0+H3 | H0–H7a collections | Interim Experimentation / Progress (Milestone 1) | H7a lead: brave nd relto vs sechk — 7/7 solved, all deltas differ; sechk first-BK latch. No Bucket 3 claim. |
...
analysed`** (`h7a_relto_vs_sechk.md`); H7b not started.
...
- Whether / when to open H7b (`future_probes.md`; remain agnostic).
- When (if ever) do H0–H7a observations become claim-worthy after further
  probes?
...
**Orchestrator / Samuel decide whether / when to open H7b**
(`future_probes.md`; remain agnostic). **H0 is closed**; **H1–H7a are
analysed**; H7b not started; **no Bucket 3 claim**. Do not expand H6 into
