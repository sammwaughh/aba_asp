...
H1 (support sensitivity on AAMAS root targets) and H2 (isolated covariate on
AAMAS target \(c\), with H2c in scope) were \textbf{approved for investigation}
on 2026-08-01 and remain \textbf{not tested} and \textbf{not claims}.
No Bucket~3 claim follows from the AAMAS baseline or from those approvals alone.
