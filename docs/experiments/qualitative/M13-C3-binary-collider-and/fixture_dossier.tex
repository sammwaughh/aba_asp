...
Approve and create target-wise configuration(s); run ABALearn once for each of
\(a,b,c\) on the frozen table; inspect learned frameworks against the
evaluator-only reference while preserving the distinctions in Section~1.
No Bucket~3 claim follows from the pre-run stage alone.
