...
claim. H7b, the cautious-nd \code{relto}--\code{sechk} comparison, is underway
and is deliberately excluded from the findings and candidate claims below.
...
recovery. H7b is intentionally absent.
...
revisited after H7b and supervisor review.
...
\boundary Bounded to brave nd on two fixtures; H7b is needed before extension
to cautious semantics. No method ranking.
...
\begin{itemize}
  ...
  \item H7b is underway and may qualify H7a.
\end{itemize}
