...
\texttt{h4b\_cautious\_split\_under\_a.md}); H5 analysed (\texttt{h5\_greedy\_cautious.md}); H6/H7 signposted only.
...
H4, H4b, and H5 are run / analysed as recorded in
\texttt{future\_probes.md}; H6/H7 are signposted only.
