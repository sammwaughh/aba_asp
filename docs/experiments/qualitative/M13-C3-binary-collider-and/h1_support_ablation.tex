...
\texttt{h3\_bk\_leading\_distractor.md}; H4 is run / analysed
(\texttt{h4\_cautious\_vs\_brave.md}); H5 deferred; H6/H7 signposted only.
...
H4 is run / analysed; H5 remains deferred as recorded in
