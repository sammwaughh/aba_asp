...
\begin{itemize}
  ...
  \item H5, H6, and H7a analysed separately
    ...
    \texttt{h7a\_relto\_vs\_sechk.md}); H7b not started.
    H6/H7a are not this H4 evidence body.
\end{itemize}
...
H4 traces and are now run / analysed in separate records. H7b is not started.

\section{Next}

H4 documentation is complete.
H4b and H5 are run / analysed separately.
H6 and H7a are analysed separately; H7b is not started.
