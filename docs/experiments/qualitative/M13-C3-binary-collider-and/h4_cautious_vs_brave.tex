...
H4b analysed separately (\texttt{h4b\_cautious\_split\_under\_a.md}); H5 deferred; H6/H7 signposted.
...
\begin{itemize}
  ...
  \item H5 deferred; H6/H7 signposted only --- not this evidence body.
\end{itemize}
...
are future probes prompted by H4 traces, not yet approved runs.

\section{Next}

H4 documentation is complete.
H4b is run / analysed separately.
H5 deferred; H6/H7 signposted.
