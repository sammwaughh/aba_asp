...
- Bucket 3 investigation and claims record:
  ...
  H0–H5 complete / analysed (incl. H4b), H6/H7 signposted, and no Bucket 3 claim
  or run matrix.
...
H0–H5 are complete / analysed (incl. H4b); H6/H7 are
...
- H4b analysed cautious split probe: `h4b_cautious_split_under_a.md` / `.tex`
  ...
  `d_val_1`;
- H5 analysed Greedy-cautious probe: `h5_greedy_cautious.md` / `.tex`
...
- remaining probe catalogue: `future_probes.md` / `.tex` (H1–H5 complete; H6/H7
  signposted only).
- H4 config:
...
complete / analysed (incl. H4b). H6/H7 are signposted only.
...
- `docs/experiments/` — experiment records and supporting structure:
  ...
  - `qualitative/M1.3-bucket3-claims.md` — Bucket 3 direction/planning record;
    H0–H5 complete / analysed (incl. H4b), H6/H7 signposted,
    and no claim.
  - `qualitative/M13-C3-binary-collider-and/` — M13-C3 hub plus H0–H5 evidence
    records and H6/H7 planning boundaries.
