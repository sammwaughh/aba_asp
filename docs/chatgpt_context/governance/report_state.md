...
1. **Milestone 1 (Weeks 1–2)** — parent-set diagnostic in four parts: **Part 1 in progress (M1.1/M11)** — initial metamorphic grid run complete; granular π/σ mechanism investigation outstanding; **Part 2 (M1.2)** — greedy vs nd deferred; Parts 3–4 — failure analysis and noise/continuous DGP investigation; first-principles success metrics beyond parent membership.
