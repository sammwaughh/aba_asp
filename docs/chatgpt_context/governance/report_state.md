...
9. **31 July Bucket 3 direction (approved method, not results)**
   ...
   - proceed one fixture at a time; H0–H7a are now complete / analysed (including
     H4b); H5 uses experimental `greedy_cautious` and is not an AAMAS-paper
     method; H6 is a procedural search-cost probe; H7a is a brave-nd
     implementation-behaviour probe; H7b is not started;
...
1. **Milestone 1** — report-ready account of unguided ABA Learning's capabilities and
   ...
   Bucket 3 H0–H7a complete / analysed under Fabrizio's 31 July direction
   (incl. H4b, H5, H6, H7a); H7b not started; no Bucket 3 claim.
...
- defer Bucket 3 report claims until a separate evidence review and Samuel's decision;
  keep project-plan status aligned with completed H0–H7a (including H4b), with
  H7b not started;
