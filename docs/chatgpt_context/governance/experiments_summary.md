...
| M12x | — | m1.2 expanded U1–U7 (ECAI/AAMAS; val-only BK; 20 cells) | run | `M1.2-expanded.md`; `M1.2-expanded-cell-inspection.md` | `M12x_{ecai2024,aamas2025}.yaml` | `M12x_summary.md`; `M12x_cell_reports/` | Interim Experimentation / Progress (Milestone 1) | Redesign re-run 2026-07-20 (20/20 solved); Stage-3 rewrite pending. Catalogue: `m12x_units_reference.tex`. |
