...
**Parent plan:** `docs/research/milestone_plans/milestone1_part1_parent_position.md`  
...
**M1.2:** unblocked as **comparator** experiment; greedy not part of this ablation plan.
