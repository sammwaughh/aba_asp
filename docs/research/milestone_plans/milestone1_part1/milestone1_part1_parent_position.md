...
**Short name:** m1.1  
**Planned path:** `docs/research/milestone_plans/milestone1_part1/milestone1_part1_parent_position.md`  
**Status:** **analysed** (Stages 0–7 complete; **closed** June 2026)  
...
| C | 7 Greedy comparator | **Done** | `M11_parent_position_greedy/`; see greedy comparator plan |
| — | Findings `.tex` | **Closed** | Integrated conclusion; Stage 7 greedy addendum |
| — | DGP documentation | **Done** | Tabular DGP clarified: isolated non-parent + `x2 := parent` (not chain sampling) |

**Answer (closed, June 2026):** binary — full parent-role tracking with σ/π invariance;
cat3 (nd) — parent-role tracking when parent feature wins first fold; σ-invariance fails under
...
The initial eight-cell **nd** grid did not:

- compare greedy and non-deterministic folding at grid scale (**Stage 7** added a formal greedy comparator on the same eight cells; **Milestone 1 Part 2** extends strategy comparison to QI fixtures);
...
**Canonical ablation plan:** `docs/research/milestone_plans/milestone1_part1/milestone1_part1_ablations.md`
...
**Update (June 2026, supervisor review — historical):** initial nd grid (Stages 0–3) was insufficient for closure; Fabrizio required granular trace + ablations. **Resolved:** Stages 4–7 complete; m1.1 **closed**. See `decisions.md` and findings tex.
...
### Required before closure or ablation grid *(all met, June 2026)*
...
### Explicitly not sufficient *(historical guidance; Stage 7 formalised greedy without replacing nd mechanism)*
