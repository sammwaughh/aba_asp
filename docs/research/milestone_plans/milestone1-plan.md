...
## Part 3: Causal-recovery capabilities and limits (M1.3) — **in progress** (Buckets 1–2 locked; Bucket 3 H0–H4 complete)
...
progress** — Buckets 1–2 locked; Bucket 3 H0–H4 complete / analysed; H5
