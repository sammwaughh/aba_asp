...
Bucket 3 H0–H7b complete / analysed (incl. H4b);
**no Bucket 3 claim**
...
| **M1.3** | **In progress** | Buckets 1–2 locked; Bucket 3 H0–H7b complete / analysed (incl. H4b); no Bucket 3 claim |
...
Bucket 3 (**H0–H7b complete / analysed, including H4b; no claim**):
`docs/experiments/qualitative/M1.3-bucket3-claims.md`.

**Immediate next step:** Orchestrator / Samuel review the completed H0–H7b
evidence and decide whether further probing or claim synthesis is warranted.
H7a is run / analysed: under brave nd, `relto` and `sechk` solved all seven
paired cells with differing deltas. H6 is run / analysed: under cautious+nd,
the long H4 root traces are driven
