...
Bucket 3 H0–H4+H4b complete / analysed; H5 cautious Greedy deferred; H6/H7
...
| **M1.3** | **In progress** | Buckets 1–2 locked; Bucket 3 H0–H4+H4b complete / analysed; H5 deferred; H6/H7 signposted; no Bucket 3 claim |
