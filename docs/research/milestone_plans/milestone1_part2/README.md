...
**Status:** **`analysed` / closed** — fresh 18-cell run + Stage-3 inspection **18/18**
(2026-07-20); evidence package locked for M1.3.
...
| Expanded implementation | Done | Fixtures `handcrafted_m12x.py`; YAMLs `M12x_{ecai2024,aamas2025}` |
| Expanded learning runs | **Done** | 18/18 `solved` (2026-07-20) |
| Summary matrix / cell reports | **Done** | `M12x_summary.md`; `M12x_cell_reports/` |
| Stage-3 qualitative write-up | **Done / closed** | `M1.2-expanded-cell-inspection.md` (18/18) |
...
**Next:** none for Part 2 — M1.3 claim drafting commencing.
