...
- Inspection: `docs/experiments/qualitative/M1.2-expanded-cell-inspection.md` (in progress; 16/18).
...
- Primary inputs: fresh M12x Stage-3 inspection + summary matrix (once locked).
