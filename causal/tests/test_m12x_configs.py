"""Expanded M1.2 (M12x) YAML expands to the locked 18-cell grid (9 per arm)."""
...
def test_m12x_expands_to_nine_cells(cfg_path: Path) -> None:
...
def test_m12x_two_arms_make_eighteen_cells() -> None:
    n = 0
