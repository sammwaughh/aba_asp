"""Expanded M1.2 (M12x) YAML expands to the locked 22-cell grid (11 per arm)."""
...
def test_m12x_expands_to_eleven_cells(cfg_path: Path) -> None:
    ...
    assert cfg.defaults.get("definitional_nz") is True
...
def test_m12x_two_arms_make_twenty_two_cells() -> None:
    n = 0
