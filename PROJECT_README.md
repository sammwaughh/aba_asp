...
- Milestone 1 Part 2 (M1.2 / M12x) is **closed** (18/18 run + Stage-3, 2026-07-20).
  **M1.3** Buckets 1–2 locked; Bucket 3 H0–H2 are complete / analysed under
  Fabrizio's one-case-at-a-time deterministic-mechanism direction. H3 has an approved
  design but has not started; H4 remains proposed / infrastructure-blocked; no Bucket 3
